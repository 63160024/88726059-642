...
if(!isset($_SESSION['loggined'])){
    ...
    echo "<div align='right'>Hello ".$SESSION['stf_name'] . "</div>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        <h1><h1 align = 'center'>Staff | <a href='newstaff.php'><span class='glyphicon glyphicon-plus'></span></a></h1>
        ...
        if ($result->num_rows == 0) {
            ...
            $table = "<table class='table table-hover'>
                        <thead>
                            <tr>
                                <th scope='col'>#</th>
                                <th scope='col'>ลำดับคณะกรรมการ</th>
